...
const AD = () => {
  ...
  return (
    // Section Wrapper
    <div className="font-pre flex flex-col bg-neutral-800 text-white">
      {/* CEO */}
      <section id="CEO" className="px-48">
        <div className="h-auto flex flex-col ">
          {/* Banner */}
          <div className="bg-AD-CEO-banner bg-cover relative w-full min-h-[36rem]">
          ...
          {/* Introduction */}
          <div className="py-16 w-full h-auto content-center">
            <div className="mx-20">
          ...
          {/* Article */}
          <article className="mx-20 space-y-12 mb-20">
            <p
              className="text-lg/8"
              data-aos="fade-up"
            ...
            <hr />
            <p
              className="text-2xl/8 text-center"
              data-aos="fade-up"
              data-aos-duration="1000"
              data-aos-dealy="200"
            >
